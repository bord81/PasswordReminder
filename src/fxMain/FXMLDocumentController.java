...
public class FXMLDocumentController implements Initializable {
    ...
    private final Logger logger = LogManager.getLogger(FXMLDocumentController.class);
    ...
    private void gpassHandler(MouseEvent event) {
        if (!pass_entered) {
            ...
            try {
                ...
                logger.debug("gpassHandler: User should enter a number: "+ex);
        ...
        if (!pass_entered) {
            ...
            if (!enter_new_entry) {
                ...
                try {
                    ...
                    logger.debug("okHandler: decodePreCheck failed: "+ex);
                    typeCorrect = false;
                }
                if (typeCorrect) {
                    if (table.getPasswords().isEmpty()) {
                ...
                if (event.getCode().equals(KeyCode.ENTER)) {
                    ...
                    if (!pass.isEmpty()) {
                        ...
                        try {
                            ...
                            logger.debug("passHandler: Incompatible file format "+ex);
